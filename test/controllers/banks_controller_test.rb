...
class BanksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bank" do
    assert_difference("Bank.count") do
      post banks_url, params: { bank: { bank_abbrv: @bank.bank_abbrv, bank_name: @bank.bank_name, total_balance: @bank.total_balance } }
    end
  ...
  test "should update bank" do
    patch bank_url(@bank), params: { bank: { bank_abbrv: @bank.bank_abbrv, bank_name: @bank.bank_name, total_balance: @bank.total_balance } }
